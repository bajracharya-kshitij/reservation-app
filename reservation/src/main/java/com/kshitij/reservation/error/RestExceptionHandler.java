...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		apiError.setDebugMessage(VALIDATION_ERROR);
	...
	public ResponseEntity<Object> handleServletException(Exception ex, HttpServletRequest request) {
	...
	public ResponseEntity<Object> handleParseException(Exception ex, HttpServletRequest request) {
		return buildResponseEntity(new ApiError(HttpStatus.BAD_REQUEST, "Parse Error", ex));
	}
	...
	protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		apiError.setMessage(String.format("The parameter '%s' of value '%s' could not be converted to type '%s'",
				ex.getName(), ex.getValue(), Optional.ofNullable(ex.getRequiredType()).map(Class::getSimpleName)));
		apiError.setDebugMessage(ex.getMessage());
		return buildResponseEntity(apiError);
	}
